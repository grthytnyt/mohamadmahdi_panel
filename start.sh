...
REPO="${SPIDER_REPO:-https://github.com/grthytnyt/mohamadmahdi_panel.git}"
BRANCH="${SPIDER_BRANCH:-main}"

INSTALLER_URL="${SPIDER_INSTALLER_URL:-https://raw.githubusercontent.com/grthytnyt/mohamadmahdi_panel/main/start.sh}"
