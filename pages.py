...
:root {
  ...
  --shadow-glow: 0 0 60px rgba(20,184,166,.15), 0 0 120px rgba(45,212,191,.08);
  --radius-sm: 12px;
  --radius: 18px;
  --radius-lg: 24px;
  --radius-xl: 28px;
...
[data-theme="dark"] {
  ...
  --shadow-glow: 0 0 80px rgba(20,184,166,.2), 0 0 160px rgba(45,212,191,.12);
}
...
/* Grid */
.grid-bg{position:fixed;inset:0;background-image:linear-gradient(rgba(20,184,166,.04) 1px,transparent 1px),linear-gradient(90deg,rgba(20,184,166,.04) 1px,transparent 1px);background-size:50px 50px;z-index:0;opacity:.6}
/* Particles */
...
.login-card::before{content:'';position:absolute;top:0;right:0;width:200px;height:200px;background:radial-gradient(circle,rgba(20,184,166,.08),transparent 70%);pointer-events:none}
.login-card::after{content:'';position:absolute;bottom:0;left:0;width:180px;height:180px;background:radial-gradient(circle,rgba(45,212,191,.08),transparent 70%);pointer-events:none}
/* Spider Logo */
.spider-logo{display:flex;align-items:center;justify-content:center;margin-bottom:28px;position:relative;z-index:1}
.spider-svg{width:80px;height:80px;filter:drop-shadow(0 4px 12px rgba(20,184,166,.3))}
...
.input-wrap input:focus{border-color:var(--spider-blue);background:rgba(255,255,255,.9);box-shadow:0 0 0 4px rgba(20,184,166,.1)}
[data-theme="dark"] .input-wrap input:focus{background:rgba(15,23,42,.8);box-shadow:0 0 0 4px rgba(20,184,166,.15)}
...
.eye-toggle:hover{color:var(--spider-purple);background:rgba(45,212,191,.08)}
/* Error */
...
/* Hint */
.login-hint{display:flex;align-items:center;justify-content:space-between;gap:10px;background:rgba(20,184,166,.06);border:1px solid rgba(20,184,166,.15);border-radius:var(--radius-sm);padding:11px 16px;margin-bottom:20px;position:relative;z-index:1}
.hint-label{font-size:11px;color:var(--text-secondary);font-weight:500}
.hint-value{font-family:'Inter',monospace;font-size:14px;font-weight:700;color:var(--spider-blue);background:rgba(20,184,166,.1);border:1px solid rgba(20,184,166,.2);padding:4px 14px;border-radius:10px;cursor:pointer;transition:all .2s ease;letter-spacing:.06em}
.hint-value:hover{background:rgba(20,184,166,.18);transform:translateY(-1px)}
/* Submit button */
...
.login-btn:hover{transform:translateY(-2px);box-shadow:0 8px 30px rgba(20,184,166,.3),0 4px 12px rgba(45,212,191,.2)}
...
/* ============ CSS VARIABLES ============ */
:root{
  --spider-blue:#14b8a6;--spider-purple:#2dd4bf;--spider-red:#FF2352;
...
::-webkit-scrollbar-thumb{background:rgba(20,184,166,.15);border-radius:3px}
::-webkit-scrollbar-thumb:hover{background:rgba(20,184,166,.3)}
...
.sidebar-logo svg{width:36px;height:36px;filter:drop-shadow(0 2px 8px rgba(20,184,166,.3));flex-shrink:0}
...
.nav-item:hover{background:rgba(20,184,166,.06);color:var(--text-primary)}
.nav-item.active{background:linear-gradient(135deg,rgba(45,212,191,.1),rgba(20,184,166,.08));color:var(--spider-purple);border-right-color:var(--spider-purple);font-weight:700}
.nav-item.active i{color:var(--spider-purple)}
.nav-badge{margin-right:auto;background:rgba(20,184,166,.12);color:var(--spider-blue);font-size:9px;padding:2px 7px;border-radius:20px;font-weight:700}
.sidebar-footer{padding:12px 16px;border-top:1px solid var(--border);flex-shrink:0}
.sidebar-user{display:flex;align-items:center;gap:10px;margin-bottom:10px}
.sidebar-avatar{width:38px;height:38px;border-radius:var(--radius-sm);background:var(--gradient-purple);display:flex;align-items:center;justify-content:center;color:#fff;font-size:16px;flex-shrink:0;box-shadow:0 4px 12px rgba(45,212,191,.3)}
...
.theme-btn{display:flex;align-items:center;justify-content:center;gap:7px;width:100%;padding:9px;border:none;border-radius:var(--radius-sm);background:rgba(20,184,166,.06);color:var(--text-secondary);font-family:inherit;font-size:11.5px;font-weight:600;cursor:pointer;transition:all .2s;border:1px solid var(--border)}
.theme-btn:hover{background:rgba(20,184,166,.12);color:var(--text-primary)}
...
.mob-btn{background:rgba(20,184,166,.06);border:1px solid var(--border);color:var(--text-secondary);width:34px;height:34px;border-radius:10px;font-size:16px;display:flex;align-items:center;justify-content:center;cursor:pointer}
...
.bell-btn{width:38px;height:38px;border-radius:var(--radius-sm);background:rgba(20,184,166,.06);border:1px solid var(--border);color:var(--text-secondary);display:flex;align-items:center;justify-content:center;cursor:pointer;font-size:17px;transition:all .2s;position:relative}
.bell-btn:hover{background:rgba(20,184,166,.12);color:var(--spider-blue)}
...
.btn-primary{background:var(--gradient);color:#fff;box-shadow:0 4px 16px rgba(20,184,166,.25)}
.btn-primary:hover{transform:translateY(-2px);box-shadow:0 8px 24px rgba(20,184,166,.35)}
.btn-primary:active{transform:translateY(0)}
.btn-ghost{background:rgba(20,184,166,.06);color:var(--spider-blue);border:1px solid rgba(20,184,166,.15)}
.btn-ghost:hover{background:rgba(20,184,166,.12)}
...
.btn-purple{background:rgba(45,212,191,.08);color:var(--spider-purple);border:1px solid rgba(45,212,191,.15)}
.btn-purple:hover{background:rgba(45,212,191,.15)}
...
.badge-blue{background:rgba(20,184,166,.1);color:var(--spider-blue)}
.badge-green{background:rgba(22,163,74,.1);color:var(--success)}
.badge-red{background:rgba(255,35,82,.1);color:var(--spider-red)}
.badge-purple{background:rgba(45,212,191,.1);color:var(--spider-purple)}
...
.stat-card:hover{transform:translateY(-3px);border-color:rgba(20,184,166,.2);box-shadow:var(--shadow-hover)}
...
.stat-icon.blue{background:rgba(20,184,166,.1);color:var(--spider-blue)}
.stat-icon.purple{background:rgba(45,212,191,.1);color:var(--spider-purple)}
...
.qa-btn:hover{background:var(--gradient);color:#fff;border-color:transparent;box-shadow:0 6px 20px rgba(20,184,166,.25);transform:translateY(-2px)}
...
.srv-bar-track{height:8px;border-radius:4px;background:rgba(20,184,166,.08);overflow:hidden}
...
.table-wrap th{background:rgba(20,184,166,.04);font-size:10px;font-weight:800;color:var(--text-secondary);text-transform:uppercase;letter-spacing:.06em;padding:12px 14px;text-align:right;border-bottom:1px solid var(--border);position:sticky;top:0;z-index:1}
...
.table-wrap tr:hover td{background:rgba(20,184,166,.03)}
.table-wrap tr:last-child td{border-bottom:none}
.proto-badge{font-size:9px;padding:3px 8px;border-radius:6px;font-weight:700}
.pb-vless{background:rgba(20,184,166,.1);color:var(--spider-blue)}
.pb-vmess{background:rgba(45,212,191,.1);color:var(--spider-purple)}
...
.usage-bar{height:6px;border-radius:3px;background:rgba(20,184,166,.08);overflow:hidden;margin-bottom:3px}
...
.modal-head::before{content:'';position:absolute;top:0;right:0;width:150px;height:150px;background:radial-gradient(circle,rgba(45,212,191,.06),transparent 70%);pointer-events:none}
...
.modal-close{width:32px;height:32px;border-radius:10px;background:rgba(20,184,166,.06);border:1px solid var(--border);color:var(--text-secondary);display:flex;align-items:center;justify-content:center;cursor:pointer;font-size:16px;transition:all .2s}
...
.form-input:focus{border-color:var(--spider-blue);box-shadow:0 0 0 3px rgba(20,184,166,.1)}
...
.cfg-card-item:hover{border-color:rgba(20,184,166,.2);transform:translateY(-2px);box-shadow:var(--shadow-hover)}
...
.log-icon-s.info{background:rgba(20,184,166,.1);color:var(--spider-blue)}
...
<aside class="sidebar" id="sidebar">
  <div class="sidebar-logo">
    <svg width="36" height="36" viewBox="0 0 100 100"><defs><linearGradient id="sg1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#14b8a6"/><stop offset="50%" style="stop-color:#2dd4bf"/><stop offset="100%" style="stop-color:#0d9488"/></linearGradient></defs><path d="M50,50 L10,15 M50,50 L15,50 M50,50 L10,85 M50,50 L90,15 M50,50 L85,50 M50,50 L90,85 M50,50 L30,5 M50,50 L70,5" stroke="url(#sg1)" stroke-width="2.5" fill="none" stroke-linecap="round"/><ellipse cx="50" cy="46" rx="18" ry="22" fill="url(#sg1)"/><ellipse cx="50" cy="23" rx="12" ry="10" fill="url(#sg1)"/><circle cx="44.5" cy="20" r="3" fill="#fff"/><circle cx="55.5" cy="20" r="3" fill="#fff"/><circle cx="45" cy="19.5" r="1.2" fill="#1a1a2e"/><circle cx="56" cy="19.5" r="1.2" fill="#1a1a2e"/></svg>
...
<main class="main">
        ...
        <div class="form-row" style="margin-bottom:12px">
          <div class="form-field">
            ...
            <div style="display:flex;flex-wrap:wrap;gap:8px;margin-top:6px">
              <label style="display:flex;align-items:center;gap:5px;font-size:12px;cursor:pointer;padding:6px 12px;background:rgba(20,184,166,.06);border-radius:8px;border:1px solid var(--border)"><input type="checkbox" id="set-proto-vless" checked onchange="updateProtoCheckboxes()"> VLESS</label>
              <label style="display:flex;align-items:center;gap:5px;font-size:12px;cursor:pointer;padding:6px 12px;background:rgba(45,212,191,.06);border-radius:8px;border:1px solid var(--border)"><input type="checkbox" id="set-proto-vmess" onchange="updateProtoCheckboxes()"> VMess</label>
  ...
  <section class="page" id="page-node">
    <div class="topbar">
      <div><div class="topbar-title"><i class="ti ti-server"></i> Nodeها</div><div class="topbar-sub">هر Node یک پنل جداست؛ بعد از اولین Node، اینباند Node ساخته می‌شود</div></div>
  ...
  try{
    ...
    if(d.hourly){
      ...
      if(trafficChart){trafficChart.data.labels=labels;trafficChart.data.datasets[0].data=vals;trafficChart.update()}
        ...
        grad.addColorStop(0,'rgba(20,184,166,.45)');grad.addColorStop(1,'rgba(20,184,166,0)');
        trafficChart=new Chart(ctx,{
          ...
          options:{responsive:true,maintainAspectRatio:false,plugins:{legend:{display:false}},
            scales:{x:{grid:{display:false},ticks:{font:{size:9}}},y:{grid:{color:'rgba(20,184,166,.05)'},ticks:{font:{size:9},callback:function(v){return v+' MB'}}}},
...
async function loadNodes(){
  try{var r=await authFetch('/api/nodes'),d=await r.json();var t=document.getElementById('nodes-table');
    ...
    var hint=document.getElementById('panel-api-key-hint'); if(hint){try{var kr=await authFetch('/api/panel-api-key'),kd=await kr.json();hint.textContent=kd.api_key?'API Key این پنل برای قرار دادن روی Node: '+kd.api_key:''}catch(_){}}
  }catch(e){console.error(e)}
}
...
def get_public_page_html(uuid_key: str) -> str:
    """صفحه پابلیک سابسکریپشن"""
    return f"""<!DOCTYPE html>
<html lang="fa" dir="rtl">
<head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0">
<title>اشتراک · محمد مهدی احمدی</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Vazirmatn:wght@400;500;600;700;800&family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet">
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@tabler/icons-webfont@3.19.0/dist/tabler-icons.min.css">
...
.brand svg{{width:38px;height:38px;filter:drop-shadow(0 3px 8px rgba(20,184,166,.3))}}
...
.theme-toggle:hover{{background:rgba(20,184,166,.1);color:var(--spider-blue)}}
/* Info card */
...
.info-card::before{{content:'';position:absolute;top:0;right:0;width:180px;height:180px;background:radial-gradient(circle,rgba(45,212,191,.08),transparent 70%);pointer-events:none}}
...
.info-stat{{text-align:center;padding:12px 8px;background:rgba(20,184,166,.04);border-radius:var(--radius);border:1px solid var(--border)}}
...
.cfg-card:hover{{border-color:rgba(20,184,166,.2);transform:translateY(-2px);box-shadow:var(--shadow-md)}}
...
.btn i{{font-size:13px}}
.btn-p{{background:linear-gradient(90deg,var(--spider-blue),var(--spider-purple));color:#fff;box-shadow:0 4px 14px rgba(20,184,166,.25)}}
.btn-p:hover{{transform:translateY(-1px);box-shadow:0 6px 20px rgba(20,184,166,.35)}}
.btn-ghost{{background:rgba(20,184,166,.06);color:var(--spider-blue);border:1px solid rgba(20,184,166,.15)}}
.btn-ghost:hover{{background:rgba(20,184,166,.12)}}
/* Password lock */
...
.lock-icon{{width:64px;height:64px;border-radius:18px;background:rgba(20,184,166,.1);border:1px solid rgba(20,184,166,.2);display:flex;align-items:center;justify-content:center;margin:0 auto 18px;font-size:28px;color:var(--spider-blue)}}
...
.lock-input:focus{{border-color:var(--spider-blue);box-shadow:0 0 0 4px rgba(20,184,166,.1)}}
...
<div class="wrap">
  <div class="top-bar">
    <div class="brand">
      <svg width="38" height="38" viewBox="0 0 100 100"><defs><linearGradient id="bgg" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#14b8a6"/><stop offset="50%" style="stop-color:#2dd4bf"/><stop offset="100%" style="stop-color:#0d9488"/></linearGradient></defs><ellipse cx="50" cy="48" rx="17" ry="20" fill="url(#bgg)"/><ellipse cx="50" cy="26" rx="11" ry="9" fill="url(#bgg)"/><circle cx="46" cy="23" r="2.5" fill="#fff"/><circle cx="54" cy="23" r="2.5" fill="#fff"/><path d="M50,50 L12,16 M50,50 L16,50 M50,50 L12,84 M50,50 L88,16 M50,50 L84,50 M50,50 L88,84" stroke="url(#bgg)" stroke-width="2.2" fill="none" stroke-linecap="round"/></svg>
      <div><div class="brand-name">محمد مهدی احمدی</div><div class="brand-sub">پنل مدیریت</div></div>
    </div>
  ...
  <div class="footer">محمد مهدی احمدی</div>
</div>
<script>
